-- SilenceXD_v2.3.lua - Galaxy Edition (REFINED)
...
btnInfo.MouseButton1Click:Connect(function() switchPage("Info", "About SilenceXD") end)
...
FreecamModule.SetMainGuiName("SilenceXD")
...
makeToggle(catHideStats, "⚡ Enable Hide Stats", function(on)
    ...
    if on then
        HideStats.Enable()
        Notify.Send("Hide Stats ✨", "Hide Stats aktif! '-SilenceXD-' berkilau di atas nama.", 3)
    else
        HideStats.Disable()
    ...
    if requestFunc then
        ...
        local testPayload = {
            embeds = {{
                ...
                description = "Your Discord webhook is working correctly!\n\nSilenceXD GUI is ready to send fish notifications." .. filterText,
                color = 3447003,
                footer = {
                    text = "SilenceXD Webhook Test • " .. os.date("%m/%d/%Y %H:%M"),
...
print("━━━━━━━━━━━━━━━━━━━━━━")
print("✨ SilenceXD v2.3 ")
print("FREE NOT FOR SALE")
print("━━━━━━━━━━━━━━━━━━━━━━")
print("💎 Created By SilenceXD Team")
print("━━━━━━━━━━━━━━━━━━━━━━")
